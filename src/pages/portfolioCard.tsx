      ...
      <div className="order-2 md:order-1 flex flex-col gap-8  md:col-span-2 col-span-1">
        <div className="flex flex-col gap-2">
          <p className="text-lg md:text-4xl font-bold ">
            Hi, I'm Saif Muhammed👋
          </p>
          <p className="text-gray-600 text-sm leading-relaxed tracking-normal">
            I’m a Full Stack Developer with 1.9 years of experience in React.js,
            TypeScript, and Node.js. I specialize in building fast, responsive
            web applications with clean, maintainable code using Tailwind CSS. I
            enjoy solving real-world problems, collaborating with teams, and
            continually learning new technologies to enhance my skills.
          </p>
        </div>
        <div className="flex flex-col">
          <div className="text-gray-600 text-sm dark:text-white  flex gap-2">
            <MapPin />{" "}
            <p className="items-end align-bottom">Ernakulam ,Kerala</p>
          </div>
          <div className="text-gray-600 text-sm dark:text-white  flex gap-2">
            {" "}
            <Dot className="text-green-600 text-2xl" />{" "}
            <p className="items-end align-bottom">Avaliable to work</p>
          </div>
        </div>
        <div className="text-gray-600 text-sm dark:text-white flex gap-2">
          <a href="https://www.linkedin.com/in/saif-muhammed-b94941145">
            <Linkedin />
          </a>
          <a href="https://github.com/saifmuhammad1">
            <Github />
          </a>
          <a href="">
            <Instagram />
